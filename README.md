...
- 🚀 PhD candidate in trajectory optimisation and optimal control for launch vehicles  
- 💻 Developing simulation and optimisation tools for multi-phase flight dynamics
- 🛰️ Interested in GNC/AOCS, control systems, numerical methods, and orbital dynamics  
